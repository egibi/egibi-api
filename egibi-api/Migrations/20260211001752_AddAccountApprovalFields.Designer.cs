...
namespace egibi_api.Migrations
{
    ...
    [Migration("20260211001752_AddAccountApprovalFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("egibi_api.Data.Entities.AccountType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 2, 11, 0, 17, 52, 451, DateTimeKind.Utc).AddTicks(8589),
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 2, 11, 0, 17, 52, 451, DateTimeKind.Utc).AddTicks(8592),
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 2, 11, 0, 17, 52, 451, DateTimeKind.Utc).AddTicks(8593),
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 2, 11, 0, 17, 52, 451, DateTimeKind.Utc).AddTicks(8595),
            ...
            modelBuilder.Entity("egibi_api.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<string>("EncryptedRecoveryCodes")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("egibi_api.Data.Entities.FundingSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("PlaidAccountMask")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("PlaidAccountName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.ToTable("FundingSource", (string)null);
                });

            modelBuilder.Entity("egibi_api.Data.Entities.InviteCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("egibi_api.Data.Entities.InviteRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("InviteRequest", (string)null);
                });
            ...
            modelBuilder.Entity("egibi_api.Data.Entities.UserPlaidConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("UserPlaidConfig", (string)null);
                });
